...
class CommandeRepository extends ServiceEntityRepository
{
    ...
    /**
    * @return Commande[] Returns an array of Order objects
    */
    ...
    * @return Commande[] Returns an array of Order objects
    */
    // public function findWithLignesCommandes()
    // {
    //     return $this->createQueryBuilder('commande')  
    //         ->Select('commande')
           
    //         // ->innerJoin('App\Entity\LigneCommande', 'LC', 'WITH', 'commande.id = LC.id_commande') 
    //         ->leftJoin('App\Entity\LigneCommande', 'LC', 'WITH', 'commande.id = LC.id_commande')
